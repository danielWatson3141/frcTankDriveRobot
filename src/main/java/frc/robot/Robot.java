...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    bButton = new JoystickButton(myController,1); //reset servo angle
    ServoReset sr = new ServoReset(servo);
    bButton.whenPressed(new InstantCommand(sr));
  ...
  private class ServoReset implements Runnable{
    Servo servo;
    public ServoReset(Servo s){
      servo = s;
    }
